...
SCRIPT
  ...
  # Install Python 3.7 once
  config.vm.provision 'shell', path: 'scripts/setup-python-3.7.sh', run: 'once', env: GUEST_DIRS

  config.vm.provision 'shell', path: 'scripts/install-tools.sh', run: 'always', env: GUEST_DIRS
